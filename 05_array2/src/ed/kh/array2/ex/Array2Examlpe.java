...
public class Array2Examlpe {
	...
	public void ex1() {
		...
		// 2차원 배열의 선언
		 ...
		 //int[][] arr;
		 //int[] arr[];
		// -> int 형 2차원 배열을 참조하는 참조변수 arr 선언
		// 참조변수 == 참조형 == 래퍼런스 변수 == 레퍼런스
		
		// 2차원 배열 할당
		// -> new 자료형[행][열];
		arr = new int[2][3];
		// heap 영역에 int 2차원 배열에 2행 3열 공간을 할당
		// 그 공간에 주소를 arr 참조변수에 대입
		
		// 2차원 배열 초기화
		// 1) 행과 열 인덱스를 이용해서 직접 초기화
		/*  
		    arr[0][0] =10;
			arr[0][1] =20;
			arr[0][2] =30;
		...
		// 2) 2중 for문을 이용한 초기화
			...
			// Arrays.deepToString() : 참조하고 있는 배열의 실제 데이터가 나오는 부분까지
	...
	public void ex3() { 
		...
		// 나중에 서로 크기가 다른 배열을 생성하며 참조하는 배열
